          ...
          {steps.map((step, index) => (
            <Card key={index} className="relative border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
              <CardHeader className="text-center pb-4">
                <div className="mx-auto w-12 h-12 bg-gradient-to-br from-red-500 to-orange-500 rounded-full flex items-center justify-center mb-4 relative">
                  <step.icon className="w-6 h-6 text-white" />
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center text-xs font-bold text-red-600 border-2 border-red-200">
                    {index + 1}
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-2xl p-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                <p className="font-semibold text-red-600 dark:text-red-400">Verified Community</p>
                <p className="text-gray-600 dark:text-gray-300">Connect with authenticated storytellers</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                <p className="font-semibold text-red-600 dark:text-red-400">No Cost Required</p>
                <p className="text-gray-600 dark:text-gray-300">Completely free after verification</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                <p className="font-semibold text-red-600 dark:text-red-400">Group Experience</p>
